...
struct scope
{
    ...
    // The total number of bytes the scope uses. Aligned to 16 bytes.
    size_t size;
...
struct compile_process
{
    ...
    struct 
    {
        // Current active symbol tale -> struct symbol*
        struct vector* table;
...
struct datatype
{
    ...
    // handling of : long long a or long int b
    ...
    union
    {
        ...
        struct body
        {
            ...
            */
            ...
            // the size of combined varaibles inside the body
            size_t size;
...
enum
{
    ...
    DATATYPE_FLAG_IS_LITERAL = 0b1000000000
};
